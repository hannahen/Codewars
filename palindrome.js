 ...
 * In addition to a few predefined tests, your function will also be tested against a random string generator 50 times which 
 * are guaranteed to produce valid palindromes.
 *
 * NOTE: reverse/reverse! have been disabled for String/Array and reverse() for JS.
 * Challenge by @driedyam on codewars.com
 */

function palindrome(string) {
  var ar = string.toLowerCase().replace(/\W/g, '').split("");
